...
CREATE SCHEMA IF NOT EXISTS sakila AUTHORIZATION admin;
SET search_path = sakila, pg_catalog;
...
ALTER TABLE sakila.actor_actor_id_seq OWNER TO admin;
...
CREATE TABLE actor (
    actor_id integer DEFAULT nextval('sakila.actor_actor_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.actor OWNER TO admin;
...
ALTER TYPE sakila.mpaa_rating OWNER TO admin;
...
ALTER DOMAIN sakila.year OWNER TO admin;
...
ALTER FUNCTION sakila._group_concat(text, text) OWNER TO admin;
...
ALTER AGGREGATE sakila.group_concat(text) OWNER TO admin;
...
ALTER TABLE sakila.category_category_id_seq OWNER TO admin;
...
CREATE TABLE category (
    category_id integer DEFAULT nextval('sakila.category_category_id_seq'::regclass) NOT NULL,
    name character varying(25) NOT NULL,
    last_update timestamp without time zone DEFAULT now() NOT NULL
);


ALTER TABLE sakila.category OWNER TO admin;
...
ALTER TABLE sakila.film_film_id_seq OWNER TO admin;
...
CREATE TABLE film (
    film_id integer DEFAULT nextval('sakila.film_film_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.film OWNER TO admin;
...
ALTER TABLE sakila.film_actor OWNER TO admin;
...
ALTER TABLE sakila.film_category OWNER TO admin;
...
ALTER TABLE sakila.actor_info OWNER TO admin;
...
ALTER TABLE sakila.address_address_id_seq OWNER TO admin;
...
CREATE TABLE address (
    address_id integer DEFAULT nextval('sakila.address_address_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.address OWNER TO admin;
...
ALTER TABLE sakila.city_city_id_seq OWNER TO admin;
...
CREATE TABLE city (
    city_id integer DEFAULT nextval('sakila.city_city_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.city OWNER TO admin;
...
ALTER TABLE sakila.country_country_id_seq OWNER TO admin;
...
CREATE TABLE country (
    country_id integer DEFAULT nextval('sakila.country_country_id_seq'::regclass) NOT NULL,
    country character varying(50) NOT NULL,
    last_update timestamp without time zone DEFAULT now() NOT NULL
);


ALTER TABLE sakila.country OWNER TO admin;
...
ALTER TABLE sakila.customer_customer_id_seq OWNER TO admin;
...
CREATE TABLE customer (
    customer_id integer DEFAULT nextval('sakila.customer_customer_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.customer OWNER TO admin;
...
ALTER TABLE sakila.customer_list OWNER TO admin;
...
ALTER TABLE sakila.film_list OWNER TO admin;
...
ALTER TABLE sakila.inventory_inventory_id_seq OWNER TO admin;
...
CREATE TABLE inventory (
    inventory_id integer DEFAULT nextval('sakila.inventory_inventory_id_seq'::regclass) NOT NULL,
    film_id integer NOT NULL,
    store_id integer NOT NULL,
    last_update timestamp without time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE sakila.inventory OWNER TO admin;
...
ALTER TABLE sakila.language_language_id_seq OWNER TO admin;
...
CREATE TABLE language (
    language_id integer DEFAULT nextval('sakila.language_language_id_seq'::regclass) NOT NULL,
    name character(20) NOT NULL,
    last_update timestamp without time zone DEFAULT now() NOT NULL
);


ALTER TABLE sakila.language OWNER TO admin;
...
ALTER TABLE sakila.nicer_but_slower_film_list OWNER TO admin;
...
ALTER TABLE sakila.payment_payment_id_seq OWNER TO admin;
...
CREATE TABLE payment (
    payment_id integer DEFAULT nextval('sakila.payment_payment_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.payment OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_01 OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_02 OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_03 OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_04 OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_05 OWNER TO admin;
...
ALTER TABLE sakila.payment_p2007_06 OWNER TO admin;
...
ALTER TABLE sakila.rental_rental_id_seq OWNER TO admin;
...
CREATE TABLE rental (
    rental_id integer DEFAULT nextval('sakila.rental_rental_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.rental OWNER TO admin;
...
ALTER TABLE sakila.sales_by_film_category OWNER TO admin;
...
ALTER TABLE sakila.staff_staff_id_seq OWNER TO admin;
...
CREATE TABLE staff (
    staff_id integer DEFAULT nextval('sakila.staff_staff_id_seq'::regclass) NOT NULL,
    first_name character varying(45) NOT NULL,
    last_name character varying(45) NOT NULL,
    address_id integer NOT NULL,
    email character varying(50),
...
ALTER TABLE sakila.staff OWNER TO admin;
...
ALTER TABLE sakila.store_store_id_seq OWNER TO admin;
...
CREATE TABLE store (
    store_id integer DEFAULT nextval('sakila.store_store_id_seq'::regclass) NOT NULL,
...
ALTER TABLE sakila.store OWNER TO admin;
...
ALTER TABLE sakila.sales_by_store OWNER TO admin;
...
ALTER TABLE sakila.staff_list OWNER TO admin;
...
ALTER FUNCTION sakila.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO admin;
...
ALTER FUNCTION sakila.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO admin;
...
ALTER FUNCTION sakila.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO admin;
...
ALTER FUNCTION sakila.inventory_held_by_customer(p_inventory_id integer) OWNER TO admin;
...
ALTER FUNCTION sakila.inventory_in_stock(p_inventory_id integer) OWNER TO admin;
...
ALTER FUNCTION sakila.last_day(timestamp without time zone) OWNER TO admin;
...
ALTER FUNCTION sakila.last_updated() OWNER TO admin;
...
ALTER FUNCTION sakila.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO admin;
